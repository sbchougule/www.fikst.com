...
<?php if( have_rows('flexible_content') ): $i = 0; echo '<section class="additional-content">';
		...
		<section class="accordian-tabs-module" id="accordian-tabs-module-<?php echo $i ?>">
		 	<div class="container <?php echo !empty(get_sub_field('container_padding')) ? get_sub_field('container_padding') : 'py-5' ?>">		 	
				...
				<ul class="accordion-tabs">
					<?php if( have_rows('tab_content_row') ): while ( have_rows('tab_content_row') ) : the_row(); ?><li class="tab-header-and-content"><a href="javascript:void(0)" class="tab-link"><?php the_sub_field('tab_header'); ?></a><div class="tab-content"><?php the_sub_field('tab_body'); ?></div></li><?php endwhile; ?><?php endif; ?>
				</ul>
	...
	<?php elseif( get_row_layout() == 'full_width_cta' ): ?>
		<section class="full-width-cta-test" id="full-width-cta-test<?php echo $i ?>">
			...
			<?php if( get_sub_field('section_header')): ?>
	          	<div class="container pt-5"><h2 class="cta-banner-header"><?php the_sub_field('section_header'); ?></h2></div>
	        <?php endif; ?>
	        ...
	        <section class="full-width-cta">
                <div class="fwc-wrap">
                    ...
                    <?php if( get_sub_field('section_body')): ?>
                        <h3 class="fwc-para"><?php the_sub_field('section_body'); ?></h3>
                         <?php endif; ?>
                        <?php 
	...
	<?php elseif( get_row_layout() == 'full_width_cta1' ): ?>
		<section class="fullwidth-cta1 <?php if (get_sub_field('cvp2_para_img')): ?> fixed-bg<?php endif ?>" id="fullwidth-cta1<?php echo $i ?>" <?php if (get_sub_field('fwc_bg')): ?>style="background-image: url(<?php the_sub_field('fwc_bg'); ?>);"<?php endif ?>>
			 <div class="container">
			 	<?php if (get_sub_field('fwc_heading')): ?>
		    		<h2 class="fwc-heading"><?php the_sub_field('fwc_heading'); ?></h2>
		    	<?php endif ?>

		    	<?php if (get_sub_field('fwc_description')): ?>
		    		<p class="fwc-description"><?php the_sub_field('fwc_description'); ?></p>
		    	<?php endif ?>
	...
	<?php elseif( get_row_layout() == 'full_width_cta2' ): ?>
		<section class="fullwidth-cta2 <?php if (get_sub_field('cvp2_para_img')): ?> fixed-bg<?php endif ?>" id="fullwidth-cta2<?php echo $i ?>" <?php if (get_sub_field('fwc_bg')): ?>style="background-image: url(<?php the_sub_field('fwc_bg'); ?>);"<?php endif ?>>
			 <div class="container">
			 	<div class="fwc2-wrap">
			 		<?php if (get_sub_field('fwc_heading')): ?>
			    		<h2 class="fwc2-heading"><?php the_sub_field('fwc_heading'); ?></h2>
			    	<?php endif ?>
			    	<?php 
					$link = get_sub_field('fwc_cta1');
					if( $link ): 
					    ...
					    $link_target = $link['target'] ? $link['target'] : '_self';
					    ?>
					    <span><a class="button btn btn-on-color btn-lg fwc-cta1" href="<?php echo esc_url( $link_url ); ?>" target="<?php echo esc_attr( $link_target ); ?>"><?php echo esc_html( $link_title ); ?></a></span>
					<?php endif; ?>
			 	</div>
			 </div>
		</section>
		...
		<section class="fullwidth-cta3"<?php if (get_sub_field('fwc_bg_color')): ?> style="background-color: <?php the_sub_field('fwc_bg_color'); ?>"<?php endif ?> id="fullwidth-cta3<?php echo $i ?>">
			<div class="container">
				<div class="fwc3-wrap">
					<div>
                   <?php if (get_sub_field('fwc_heading')): ?>
			    		<h2 class="fwc3-heading"><?php the_sub_field('fwc_heading'); ?></h2>
			    	<?php endif ?>
			    	</div>
			    	<div>
			    	<?php 
 	...
 	<?php elseif( get_row_layout() == 'multiple_columns' ): ?>
 		<section class="multiple-cols-module <?php if( get_sub_field('mcm_anchor_link')): ?>page-inner-anchor<?php endif; ?>" id="<?php echo !empty(get_sub_field('mcm_anchor_link')) ? get_sub_field('mcm_anchor_link') : 'multiple_columns'.$i ?>" <?php if( get_sub_field('mc_bg_color')): ?>style="background-color: <?php the_sub_field('mc_bg_color');?>" <?php endif; ?> <?php if( get_sub_field('mc_bg_color')): ?>style="background-color: <?php the_sub_field('mc_bg_color');?>" <?php endif; ?>>

		 	<div class="container <?php echo !empty(get_sub_field('container_padding')) ? get_sub_field('container_padding') : 'py-5' ?>">
		 		<div class="row">
			 		<?php if( get_sub_field('section_header')): ?>
						<h2 class="col-12"><?php the_sub_field('section_header'); ?></h2>
					<?php endif; ?>
					<?php if( get_sub_field('section_subtext')): ?>
						<p class="column-subtext col-12"><?php the_sub_field('section_subtext'); ?></p>
					<?php endif; ?>
				</div>
				<section class="row">
					<?php if (get_sub_field('number_columns') == '2') {
		         	...
		         	<?php if( have_rows('content') ): while ( have_rows('content') ) : the_row(); ?>
						...
						<div class="<?php echo $gridClass; ?> wow <?php echo $animation; ?>"><?php the_sub_field('content_column'); ?></div>
					<?php endwhile; ?>
					<?php endif; ?>				
				</section>
				<?php if( get_sub_field('divider')): ?>	
  ...
  <?php elseif( get_row_layout() == 'image_gallery_with_content' ): ?>
		<section class="image-gallery-with-content" id="img_gallery_with_thumbnails<?php echo $i ?>">
	        <div class="container ">
		        ...
		        <div class="igwc-content">
		        	<?php the_sub_field('igwtc_content'); ?>
		        </div>
		        <?php endif; ?>
	       		<?php if( get_sub_field('divider')): ?>
					<hr>
	...
	<?php elseif( get_row_layout() == 'hero_canvas' ): ?>
		<section class="hero-canvas <?php if (get_sub_field('cvp2_para_img')): ?> fixed-bg<?php endif ?>" id="hero_canvas<?php echo $i ?>" <?php if (get_sub_field('hc_bg')): ?>style="background-image: url(<?php the_sub_field('hc_bg') ?>);"<?php endif ?>>
			<div class="container">
				<div class="row">
					<div class="col-12 text-center">
						<?php if (get_sub_field('hc_heading')): ?>
							<h2 class="hc-heading"><?php the_sub_field('hc_heading') ?></h2>
						<?php endif ?>

						<?php if (get_sub_field('hc_description')): ?>
							<p class="hc-description"><?php the_sub_field('hc_description') ?></p>
						<?php endif ?>
					</div>
				</div>
			</div>
		...
		<section class="carousel-with-content" id="carousel_with_content<?php echo $i ?>">
			<div id="carouselExampleIndicators2" class="carousel slide" data-ride="carousel">
				...
				<div class="carousel-inner cwc-carousel">
					<?php while ( have_rows('cwc_carousel') ) : the_row(); ?>
				    <div class="carousel-item <?php if (get_row_index()==1): ?>active<?php endif ?>" <?php if( get_sub_field('cwc_bg') ): ?>style="background-image: url(<?php the_sub_field('cwc_bg') ?>);"<?php endif; ?>>
						<div class="container <?php echo !empty(get_sub_field('container_padding')) ? get_sub_field('container_padding') : 'py-5' ?>">
							<div class="row">
								<?php $animation = get_sub_field('animation_style') != 'none' ? get_sub_field('animation_style') . ' animated' : ''; ?>
							    <div class="carousel-content col-md-8 <?php echo $animation; ?>">
							    	<?php if (get_sub_field('cwc_title')): ?>
							    		<h2 class="cwc-title"><?php the_sub_field('cwc_title'); ?></h2>
							    	<?php endif ?>

							    	<?php if (get_sub_field('cwc_description')): ?>
							    		<p class="cwc-description"><?php the_sub_field('cwc_description'); ?></p>
							    	<?php endif ?>
		...
		<section class="content-on-carousel" id="content_on_carousel<?php echo $i ?>">
				...
				<div class="row">
				    ...
				    <div class="carousel-content <?php echo $animation; ?>">
				    	<?php if (get_sub_field('coc_title')): ?>
				    		<h2 class="coc-title"><?php the_sub_field('coc_title'); ?></h2>
				    	<?php endif ?>

				    	<?php if (get_sub_field('coc_description')): ?>
				    		<p class="coc-description"><?php the_sub_field('coc_description'); ?></p>
				    	<?php endif ?>
			...
			<div id="carouselExampleIndicators3" class="carousel slide" data-ride="carousel">
				...
				<div class="carousel-inner coc-carousel">
					<?php while ( have_rows('coc_carousel') ) : the_row(); ?>
				    <div class="carousel-item <?php if (get_row_index()==1): ?>active<?php endif ?>" <?php if( get_sub_field('coc_bg') ): ?>style="background-image: url(<?php the_sub_field('coc_bg') ?>);"<?php endif; ?>>						
				    </div>
					<?php endwhile; ?>
				</div>
				<?php endif; ?>
	...
	<?php elseif( get_row_layout() == 'blocks_hovered_content_grid' ): ?>
		<section class="blocks-hover-content-grid text-center" id="blocks_hovered_content_grid<?php echo $i ?>">
			<div class="container <?php echo !empty(get_sub_field('container_padding')) ? get_sub_field('container_padding') : '' ?>">
				<div class="row bhcg-content-wrap">
					<div class="col-12">
						<?php if (get_sub_field('bhcg_heading')): ?>
				    		<h2 class="bhcg-heading"><?php the_sub_field('bhcg_heading'); ?></h2>
				    	<?php endif ?>

				    	<?php if (get_sub_field('bhcg_descritpion')): ?>
				    		<div class="bhcg-description"><?php the_sub_field('bhcg_descritpion'); ?></div>
				    	<?php endif ?>
					</div>
				</div>
				...
				<div class="row bhcg-listing"  id="bhcg_blocks<?php echo $i ?>">
					...
					<?php $animation = get_sub_field('animation_style') != 'none' ? get_sub_field('animation_style') . ' animated' : ''; ?>	
					<div class="<?php echo $gridClass; ?> wow <?php echo $animation; ?>">
						<?php 
						...
						<?php endif; ?>
								...
								<div class="bhcg-hover-content">
									<?php if (get_sub_field('bhcg_item_title')): ?>
										<h3 class="bhcg-item-title"><?php the_sub_field('bhcg_item_title') ?></h3>
									<?php endif ?>

									<?php if (get_sub_field('bhcg_item_description')): ?>
										<p class="bhcg-item-description"><?php the_sub_field('bhcg_item_description'); ?></p>
									<?php endif ?>
									...
									if( $link ): 
									    ...
									    $link_target = $link['target'] ? $link['target'] : '_self';
									    ?>
										<span class="bhcg-item-btn btn-on-color"><?php echo esc_html( $link_title ); ?></span>
									<?php endif; ?>
								</div>
						<?php if( !$link ): ?>
						    </div>
		...
		<section class="four_blocks-hover-content-grid" id="four_blocks_hovered_content_grid<?php echo $i ?>">
			<div class="container <?php echo !empty(get_sub_field('container_padding')) ? get_sub_field('container_padding') : '' ?>">
				<div class="row fbhcg-content-wrap">
					<div class="col-12">
						<?php if (get_sub_field('fbhcg_heading')): ?>
				    		<h2 class="fbhcg-heading"><?php the_sub_field('fbhcg_heading'); ?></h2>
				    	<?php endif ?>

				    	<?php if (get_sub_field('fbhcg_descritpion')): ?>
				    		<div class="fbhcg-description"><?php the_sub_field('fbhcg_descritpion'); ?></div>
				    	<?php endif ?>
					</div>
				</div>				
				<div class="row fbhcg-listing"  id="fbhcg_blocks<?php echo $i ?>" <?php if (get_sub_field('fbhcg_bg')): ?>style="background-image: url(<?php the_sub_field('fbhcg_bg') ?>);"<?php endif ?>>
					...
					<div class="col-lg-6">
						    <div class="fbhcg-item" tabindex="0">
								<div class="fbhcg-hover-content">
									<?php if(get_sub_field('fbhcg_icon')) : ?>
										<?php $fbhcg_icon = get_sub_field('fbhcg_icon'); ?>
										<img class="fbhcg-icon" src="<?php echo $fbhcg_icon['url']; ?>" alt="<?php echo $fbhcg_icon['title']; ?>" title="<?php echo $fbhcg_icon['title']; ?>">
									<?php endif; ?>
									<?php if (get_sub_field('fbhcg_item_title')): ?>
										<h3 class="fbhcg-item-title"><?php the_sub_field('fbhcg_item_title') ?></h3>
									<?php endif ?>
									<?php if (get_sub_field('fbhcg_item_description')): ?>
										<p class="fbhcg-item-description"><?php the_sub_field('fbhcg_item_description'); ?></p>
									<?php endif ?>
									<?php 
									...
									if( $link ): 
									    ...
									    $link_target = $link['target'] ? $link['target'] : '_self';
									    ?>
										<a class="fbhcg-item-btn btn-alt-on-color" href="<?php echo esc_url( $link_url ); ?>" target="<?php echo esc_attr( $link_target ); ?>"><?php echo esc_html( $link_title ); ?></a>
									<?php endif; ?>
								</div>
						    </div>
						</div>
		...
		<section class="content-gallery-one-hover-content-grid" id="content_one_hovered_content_grid<?php echo $i ?>">
			<div class="container <?php echo !empty(get_sub_field('container_padding')) ? get_sub_field('container_padding') : 'py-5' ?>">
				<div class="row cgohcg-content-wrap">
					<div class="col-lg-3">
						<?php if (get_sub_field('cgohcg_heading')): ?>
				    		<h2 class="cgohcg-heading"><?php the_sub_field('cgohcg_heading'); ?></h2>
				    	<?php endif ?>

				    	<?php if (get_sub_field('cgohcg_descritpion')): ?>
				    		<div class="cgohcg-description"><?php the_sub_field('cgohcg_descritpion'); ?></div>
				    	<?php endif ?>
				    	<?php 
				...
				<div class="row cgohcg-listing"  id="cgohcg_blocks<?php echo $i ?>">
					...
					<?php $animation = get_sub_field('animation_style') != 'none' ? get_sub_field('animation_style') . ' animated' : ''; ?>	
					<div class="col-md-4 col-lg-4 wow <?php echo $animation; ?>">
							<?php 
						    ...
						    <a class="cgohcg-item" href="<?php echo esc_url( $link_url ); ?>" target="<?php echo esc_attr( $link_target ); ?>">
								...
								<div class="cgohcg-hover-content">
									<?php if (get_sub_field('cgohcg_item_title')): ?>
										<h3 class="cgohcg-item-title"><?php the_sub_field('cgohcg_item_title') ?></h3>
									<?php endif ?>

									<?php if (get_sub_field('cgohcg_item_description')): ?>
										<div class="cgohcg-item-description"><?php the_sub_field('cgohcg_item_description'); ?></div>
									<?php endif ?>
...
<?php elseif( get_row_layout() == 'content_gallery_two_hovered_content_grid' ): ?>
				...
				<div class="row cgthcg-content-wrap">
					<div class="col-12">
						<?php if (get_sub_field('cgthcg_heading')): ?>
				    		<h2 class="cgthcg-heading"><?php the_sub_field('cgthcg_heading'); ?></h2>
				    	<?php endif ?>

				    	<?php if (get_sub_field('cgthcg_descritpion')): ?>
				    		<p class="cgthcg-description"><?php the_sub_field('cgthcg_descritpion'); ?></p>
				    	<?php endif ?>
					</div>
				</div>
						    ...
						    <a href="<?php echo esc_url( $link_url ); ?>" target="<?php echo esc_attr( $link_target ); ?>" class="cgthcg-item <?php if (get_sub_field('cgthcg_small_box')): ?>cgthcg-item-small<?php endif ?>"  tabindex="0">
								...
								<div class="cgthcg-hover-content">
									<?php if (get_sub_field('cgthcg_item_title')): ?>
										<h3 class="cgthcg-item-title"><?php the_sub_field('cgthcg_item_title') ?></h3>
									<?php endif ?>

									<?php if (get_sub_field('cgthcg_item_description')): ?>
										<p class="cgthcg-item-description"><?php the_sub_field('cgthcg_item_description'); ?></p>
									<?php endif ?>
						    ...
						    <a href="<?php echo esc_url( $link_url2 ); ?>" target="<?php echo esc_attr( $link_target2 ); ?>" class="cgthcg-item <?php if (get_sub_field('cgthcg_two_small_box')): ?>cgthcg-item-small<?php endif ?>"  tabindex="0">
								...
								<div class="cgthcg-hover-content">
									<?php if (get_sub_field('cgthcg_two_item_title')): ?>
										<h3 class="cgthcg-item-title"><?php the_sub_field('cgthcg_two_item_title') ?></h3>
									<?php endif ?>

									<?php if (get_sub_field('cgthcg_two_item_description')): ?>
										<p class="cgthcg-item-description"><?php the_sub_field('cgthcg_two_item_description'); ?></p>
									<?php endif ?>
				...
				<div class="row bg-content-wrap">
					<div class="col-12">
						<?php if (get_sub_field('bg_heading')): ?>
				    		<h2 class="bg-heading"><?php the_sub_field('bg_heading'); ?></h2>
				    	<?php endif ?>

				    	<?php if (get_sub_field('bg_descritpion')): ?>
				    		<p class="bg-description"><?php the_sub_field('bg_descritpion'); ?></p>
				    	<?php endif ?>
					</div>
				</div>
			...
			<div class="container <?php echo !empty(get_sub_field('container_padding')) ? get_sub_field('container_padding') : 'py-5' ?>">
				...
				<?php while ( have_rows('bt_tab') ) : the_row(); ?>
					<li class="bt-nav-item" role="presentation">
		        		...
		        		<a  href="#tab<?php echo get_row_index(); ?>" data-toggle="tab" class="<?php if (get_row_index()==1): ?>active<?php endif; ?>" role="tab"><?php the_sub_field('bt_tab_title'); ?></a>
					</li>
				<?php endwhile; ?>
				</ul>
				<?php endif; ?>
					        ...
					        <div class="panel-heading">
						        <h2 class="panel-title h4">
						            <a data-toggle="collapse" data-parent=".tab-pane" href="#collapse<?php echo get_row_index(); ?>">
						              <?php the_sub_field('bt_tab_title'); ?>
						            </a>
						        </h2>
					        </div>
				          			...
				          			<div class="bt-tab-body panel-body row">
					          			...
					          			<div class="col-md-5">
					          				<?php if (get_sub_field('bt_subheading')): ?>
									    		<h2 class="bt-subheading h4"><?php the_sub_field('bt_subheading'); ?></h2>
									    	<?php endif ?>
					          				<?php if (get_sub_field('bt_heading')): ?>
									    		<h3 class="bt-heading h2"><?php the_sub_field('bt_heading'); ?></h3>
									    	<?php endif ?>

									    	<?php if (get_sub_field('bt_tab_body')): ?>
									    		<p class="bt-description"><?php the_sub_field('bt_tab_body'); ?></p>
									    	<?php endif ?>
		...
		<section class="bootstrap-tabs content-value-prop-tabs" id="content_value_prop_tabs<?php echo $i ?>">
			<div class="container">
				...
				<?php while ( have_rows('cvpt_tab') ) : the_row(); ?>
					<li class="bt-nav-item" role="presentation">
		        		<a  href="#cvptab<?php echo get_row_index(); ?>" data-toggle="tab" class="<?php if (get_row_index()==1): ?>active<?php endif; ?>" role="tab"><?php the_sub_field('cvpt_tab_title'); ?></a>
					</li>
				<?php endwhile; ?>
				</ul>
				<?php endif; ?>
						...
						<div class="panel panel-default">
					        <div class="panel-heading">
						        <h4 class="panel-title">
						            <a data-toggle="collapse" data-parent=".tab-pane" href="#collapse<?php echo get_row_index(); ?>">
						              <?php the_sub_field('cvpt_tab_title'); ?>
						            </a>
						        </h4>
					        </div>
				          			...
				          			<div class="bt-tab-body panel-body row">
					          			...
					          			<div class="col-md-6">
					          				<?php if (get_sub_field('cvpt_subheading')): ?>
									    		<h2 class="cvpt-subheading h4"><?php the_sub_field('cvpt_subheading'); ?></h2>
									    	<?php endif ?>
					          				<?php if (get_sub_field('cvpt_heading')): ?>
									    		<h3 class="cvpt-heading h2"><?php the_sub_field('cvpt_heading'); ?></h3>
									    	<?php endif ?>

									    	<?php if (get_sub_field('cvpt_tab_body')): ?>
									    		<p class="cvpt-description"><?php the_sub_field('cvpt_tab_body'); ?></p>
									    	<?php endif ?>
		...
		<section class="hero-tabs-selector" id="hero_tabs_selector<?php echo $i ?>">
			<div class="hts-slider">
			    ...
			    <div class="hts-item-wrap">
			    	<div class="row hts-item" <?php if (get_sub_field('hts_bg')): ?>style="background-image: url(<?php the_sub_field('hts_bg'); ?>);"<?php endif ?>>
			    		<div class="container">
			    			<?php if (get_sub_field('hts_heading')): ?>
								<h2 class="hts-heading"><?php the_sub_field('hts_heading'); ?></h2>
							<?php endif ?>
			    	...
			    	<div class="slider-nav">
			    		<span><?php the_sub_field('hts__tab_title'); ?></span>
			    		<?php 
	...
	<?php elseif( get_row_layout() == 'left_img_right_content_module' ): ?>
		<section class="left-img-right-content-module" id="left_img_right_content_module<?php echo $i ?>" <?php if( get_sub_field('lircm_bg')): ?>style="background-color: <?php the_sub_field('lircm_bg');?>" <?php endif; ?>>
			<div class="container <?php echo !empty(get_sub_field('container_padding')) ? get_sub_field('container_padding') : '' ?>">
				<div class="lircm-wrap <?php if( get_sub_field('lircm_image_to_right')): ?> lircm-img-right<?php endif; ?>">
          			...
          			<div class="lircm-content-wrap wow <?php echo $animation; ?>">
          				<?php if (get_sub_field('lircm_subheading')): ?>
				    		<h4 class="lircm-subheading"><?php the_sub_field('lircm_subheading'); ?></h4>
				    	<?php endif ?>
          				<?php if (get_sub_field('lircm_heading')): ?>
				    		<h2 class="lircm-heading"><?php the_sub_field('lircm_heading'); ?></h2>
				    	<?php endif ?>
				    	<?php if (get_sub_field('lircm_content')): ?>
				    		<div class="lircm-description"><?php the_sub_field('lircm_content'); ?></div>
				    	<?php endif ?>
				    	<?php 
		...
		<section class="call-to-action-buttons-module" id="call_to_action_buttons_module<?php echo $i ?>">
			<?php if( have_rows('ctabm_btns') ):  while ( have_rows('ctabm_btns') ) : the_row(); ?>
				<div class="ctabm-wrap ctabm-btn-<?php echo get_row_index() ?>">
					<?php $ctabm_icon = get_sub_field('ctabm_cta_icon'); ?>
					<?php 
					...
					if( $link ): 
					    ...
					    <a class="ctabm-btn" href="<?php echo esc_url( $link_url ); ?>" target="<?php echo esc_attr( $link_target ); ?>">
					    	<span><?php echo $link_title; ?></span> <img class="style-svg" src="<?php echo $ctabm_icon['url'] ?>" alt="<?php echo $ctabm_icon['alt'] ?>" title="<?php echo $ctabm_icon['title'] ?>">
					    </a>
					<?php endif; ?>
				</div>
			<?php endwhile; endif; ?>
		...
		<section class="blog-module1" id="blog_module1<?php echo $i ?>">
			<div class="container <?php echo !empty(get_sub_field('container_padding')) ? get_sub_field('container_padding') : 'py-5' ?>">
				<?php if (get_sub_field('blog_heading')): ?>
					<h2 class="blog-heading text-center"><?php the_sub_field('blog_heading') ?></h2>
				<?php endif ?>
	...
	<?php elseif( get_row_layout() == 'bg_img_content_module1' ): ?>
		<section class="bg-img-content-module1" id="bg_img_content_module1<?php echo $i ?>">
			<div class="container <?php echo !empty(get_sub_field('container_padding')) ? get_sub_field('container_padding') : 'py-5' ?>">
				<?php if (get_sub_field('bicm_section_heading')): ?>
					<h2 class="bicm-section-heading"><?php the_sub_field('bicm_section_heading'); ?></h2>
				<?php endif ?>

				<?php if (get_sub_field('bicm_description')): ?>
					<p class="bicm-description"><?php the_sub_field('bicm_description') ?></p>
				<?php endif ?>
			</div>

			<div class="bicm-listing container-fluid <?php the_sub_field('bicm_text_alignment') ?>">
				<?php if (have_rows('bicm_items')): ?>
					<?php while (have_rows('bicm_items')): the_row();
						...
						?>
						<div class="bicm-items row" <?php if (get_sub_field('bicm_item_bg')): ?>style="background-image: url(<?php the_sub_field('bicm_item_bg') ?>)"<?php endif ?>>
							...
							<div class="col-md-6 bicm-content-wrap">
								<div class="bicm-content <?php echo $animation;  ?>">
									...
									<?php if (get_sub_field('bicm_title')): ?>
										<h2 class="bicm-title"><?php the_sub_field('bicm_title'); ?></h2>
									<?php endif ?>
									<?php if (get_sub_field('bicm_description')): ?>
										<div class="bicm-description"><?php the_sub_field('bicm_description'); ?></div>
									<?php endif ?>
							...
							<div class="col-md-6 bicm-img-wrap">
								<img class="bicm-left-img" src="<?php the_sub_field('bicm_item_bg') ?>" alt="<?php the_sub_field('bicm_title'); ?>" title="<?php the_sub_field('bicm_title'); ?>">
							</div>
						</div>
					<?php endwhile; ?>
				<?php endif ?>
						...
						<div class="bicm-items row" <?php if (get_sub_field('bicm_item_bg')): ?>style="background-image: url(<?php the_sub_field('bicm_item_bg') ?>)"<?php endif ?>>
							...
							<div class="col-md-6 bicm-content-wrap">
								<div class="bicm-content <?php echo $animation;  ?>">
									...
									<?php endif ?>
									<?php if (get_sub_field('bicm_title')): ?>
										<h3 class="bicm-title"><?php the_sub_field('bicm_title'); ?></h3>
									<?php endif ?>
									<?php if (get_sub_field('bicm_description')): ?>
										<div class="bicm-description"><?php the_sub_field('bicm_description'); ?></div>
									<?php endif ?>
		...
		<section class="item-listing-on-bg-module text-center <?php if (get_sub_field('cvp2_para_img')): ?> fixed-bg<?php endif ?>" id="item_listing_on_bg_module<?php echo $i ?>" <?php if (get_sub_field('ilb_bg')): ?>style="background-image: url(<?php the_sub_field('ilb_bg'); ?>)"<?php endif ?>>
			<div class="container <?php echo !empty(get_sub_field('container_padding')) ? get_sub_field('container_padding') : '' ?>">
				<?php if (get_sub_field('ilb_heading')): ?>
					<h2 class="ilb-heading"><?php the_sub_field('ilb_heading'); ?></h2>
				<?php endif ?>
				<?php if (get_sub_field('ilb_description')): ?>
					<div class="ilb-description"><?php the_sub_field('ilb_description'); ?></div>
				<?php endif ?>
				...
				<div class="row ilb-listing">
					...
					<?php $animation = get_sub_field('animation_style') != 'none' ? get_sub_field('animation_style') . ' animated' : ''; ?>	
					<div class="col-lg-auto col-md-3 col-6 ilb-item wow <?php echo $animation; ?>">
						<?php
						...
						<?php if (get_sub_field('ilb_title')): ?>
							<h3 class="ilb-title"><?php the_sub_field('ilb_title'); ?></h3>
						<?php endif ?>
					</div>
					<?php endwhile; ?>
				</div>
				...
				if( $link ): 
				    ...
				    $link_target = $link['target'] ? $link['target'] : '_self';
				    ?>
					<a class="ilb-item-btn btn btn-on-color" href="<?php echo esc_url( $link_url ); ?>" target="<?php echo esc_attr( $link_target ); ?>"><?php echo esc_html( $link_title ); ?></a>
				<?php endif; ?>
			</div>
		</section>
	...
	<?php elseif( get_row_layout() == 'left_content_right_icon_title_listing_module' ): ?>
					...
					<div class="col-md-6">
						<div class="lcrilm-content-wrap">
							<?php if (get_sub_field('lcrilm_heading')): ?>
								<h2 class="lcrilm-heading"><?php the_sub_field('lcrilm_heading'); ?></h2>
							<?php endif ?>
							<?php if (get_sub_field('lcrilm_description')): ?>
								<div class="lcrilm-description"><?php the_sub_field('lcrilm_description'); ?></div>
							<?php endif ?>
							...
							<?php while (have_rows('icon_title_listing')): the_row(); ?>
								...
								<div class="col-md-6 lcrilm-icon-title-item wow <?php echo $animation; ?>">
									...
									<?php if (get_sub_field('lcrilm_title')): ?>
										<h3 class="lcrilm-title"><?php the_sub_field('lcrilm_title'); ?></h3>
									<?php endif ?>
        ...
        <section class="hero-interactive-1-module" id="buckets_hover_focus<?php echo $i ?>">
        	<?php if (get_sub_field('bhf_heading')): ?>
            	<h2 class="hi1m-heading"><?php the_sub_field('bhf_heading') ?></h2>
        	<?php endif ?>
        		<?php if (get_sub_field('number_columns') == '2') {
		        ...
		        <div class="<?php echo $gridClass; ?> hi1m-item-listing">
		        	...
		        	<?php if( have_rows('bhf_items') ): while ( have_rows('bhf_items') ) : the_row(); ?>
						...
						if( $link ): 
						    ...
						    $link_target = $link['target'] ? $link['target'] : '_self';
						    ?>
			            	<a href="<?php echo esc_url( $link_url ); ?>" target="<?php echo esc_attr( $link_target ); ?>" class="hi1m-item him-item <?php if (get_row_index()==1): ?>hi1m-item-hovered<?php endif ?>" <?php if (get_sub_field('bhf_bg')): ?>style="background-image: url(<?php the_sub_field('bhf_bg') ?>);"<?php endif ?>>
						<?php endif; ?>

				            <div class="hi1m-content">
				              	<?php if (get_sub_field('bhf_title')): ?>
				              		<h2 class="hi1m-hover-title"><?php the_sub_field('bhf_title') ?></h2>
				              	<?php endif ?>

				              	<?php if (get_sub_field('bhf_description')): ?>
				              		<div class="hi1m-description"><?php the_sub_field('bhf_description') ?></div>
				              	<?php endif ?>
				            ...
				            <?php if (get_sub_field('bhf_title')): ?>
				              	<h2 class="hi1m-title"><?php the_sub_field('bhf_title') ?></h2>
				            <?php endif ?>
        ...
        <section class="hero-interactive-1-mobile-carousel" id="buckets_hover_focus<?php echo $i ?>">
        	...
        	<?php while (have_rows('bhf_items')): the_row(); ?>
	            ...
	            <div class="hi1m-slide" <?php if (get_sub_field('bhf_bg')): ?>style="background-image: url(<?php the_sub_field('bhf_bg') ?>);"<?php endif ?>>
					<div class="container">

			            <div class="hi1m-content">
			              	<?php if (get_sub_field('bhf_title')): ?>
			              		<h3 class="hi1m-hover-title"><?php the_sub_field('bhf_title') ?></h3>
			              	<?php endif ?>
    ...
    <?php elseif( get_row_layout() == 'hero-interactive-2-module' ): ?>
        <section class="hero-interactive-2-module" id="hero-interactive-2-module<?php echo $i ?>">
            <div class="hi2m-wrapper">
                <div class="container">
                    <?php if(get_sub_field('hi2m_heading')): ?><h1 class="hi2m-header"><?php the_sub_field('hi2m_heading'); ?></h1><?php endif; ?>
                    <?php if(get_sub_field('hi2m_description')): ?><p class="hi2m-description"><?php the_sub_field('hi2m_description'); ?></p><?php endif; ?>
                </div>
            </div>

        	<div class="hi2m-carousel" <?php if(get_sub_field('hi2m_hero_image')): ?> style="background-image: url(<?php the_sub_field('hi2m_hero_image'); ?>);" <?php endif; ?>>
	        	<?php if( have_rows('hi2m_items') ): ?>
		            <?php while ( have_rows('hi2m_items') ) : the_row(); ?>
		                <div class="hi2m-slide" data-imgsrc="<?php the_sub_field('hi2m_image'); ?>" style="background-image: url(<?php the_sub_field('hi2m_image'); ?>);">

		                	<?php if(get_sub_field('hi2m_title')): ?>
		                    	<h2 class="hi2m-slide-title"  tabindex="0"><span><?php the_sub_field('hi2m_title'); ?></span></h2>
		                    <?php endif; ?>

		                    <div class="hi2m-slider-hover-content">
		                    	<?php if (get_sub_field('hi2m_title')): ?>
		                    		<h2 class="hi2m-hover-title"><?php the_sub_field('hi2m_title'); ?></h2>
		                    	<?php endif ?>

		                        <?php if(get_sub_field('hi2m_text')): ?>
		                        	<p class="hi2m-slide-description"><?php the_sub_field('hi2m_text'); ?></p>
		                        <?php endif; ?>
		                	...
		                	<div class="tm-content-wrap">
			                    ...
			                    <div class="tm-right-content">
			                    	<?php if (get_sub_field('tm_title')): ?>
			                    		<h2 class="tm-title"><?php the_sub_field('tm_title'); ?></h2>
			                    	<?php endif ?>

			                        <?php if(get_sub_field('tm_text')): ?>
			                        	<p class="tm-text"><?php the_sub_field('tm_text'); ?></p>
			                        <?php endif; ?>

			                        <?php if (get_sub_field('tm_client_name')): ?>
			                        	<strong class="tm-client-name"><?php the_sub_field('tm_client_name') ?></strong>
			                        <?php endif ?>
			                    </div>
		                	</div>
		                </div>
    ...
    <?php elseif( get_row_layout() == 'testimonial_card_module' ): ?>
    	<section class="testimonial-card-module" id="testimonial_card_module<?php echo $i ?>">
    		<div class="container">
				<?php if (get_sub_field('tmc_header')): ?>
					<h2 class="tmc-header"><?php the_sub_field('tmc_header'); ?></h2>
				<?php endif ?>
		            ...
		            <?php while ( have_rows('tcm_items') ) : the_row(); ?>
		                <div class="tcm-slide">
		                	<div class="tcm-content-wrap">
			                    ...
			                    <div class="tcm-right-content">
			                    	<?php if (get_sub_field('tcm_title')): ?>
			                    		<h2 class="tcm-title"><?php the_sub_field('tcm_title'); ?></h2>
			                    	<?php endif ?>

			                        <?php if(get_sub_field('tcm_text')): ?>
			                        	<p class="tcm-text"><?php the_sub_field('tcm_text'); ?></p>
			                        <?php endif; ?>

			                        <?php if (get_sub_field('tcm_client_name')): ?>
			                        	<span class="tcm-sub-header"><?php the_sub_field('tcm_client_name') ?></span>
			                        <?php endif ?>
			                        <div>
			                        	<?php 
							...
							if( $link ): 
							    ...
							    $link_target = $link['target'] ? $link['target'] : '_self';
							    ?>
			              		<a href="<?php echo esc_url( $link_url ); ?>" target="<?php echo esc_attr( $link_target ); ?>" class="btn btn-on-color hi2m-link"><?php echo esc_html( $link_title ); ?></a>
			              	<?php endif ?>
			                        </div>
			                    </div>
		                	</div>
    	...
    	<section class="industries-we-serve-module" id="industries_we_serve_module<?php echo $i ?>">
		    <div class="container <?php echo !empty(get_sub_field('container_padding')) ? get_sub_field('container_padding') : 'py-5' ?>">
		    	<?php if (get_sub_field('iwsm_section_heading')): ?>
		    		<h2 class="iwsm-heading "><?php the_sub_field('iwsm_section_heading'); ?></h2>
		    	<?php endif ?>
		            		...
		            		<?php while (have_rows('iwsm_tabs_items')): the_row(); ?>
			                    <a class="col-12 col-lg-6 nav-link p-2  <?php if (get_row_index()==1): ?>active<?php endif ?>" id="v-pills-<?php echo get_row_index(); ?>-tab" data-toggle="pill" href="#v-pills-<?php echo get_row_index(); ?>" role="tab" aria-controls="v-pills-<?php echo get_row_index(); ?>" aria-selected="<?php if (get_row_index()==1): ?>true<?php else: ?>false<?php endif ?>">
			                        ...
			                        <?php if (get_sub_field('iwsm_title')): ?>
			                        	<span class="font-weight-bold small text-uppercase"><?php the_sub_field('iwsm_title') ?></span>
			                        <?php endif ?>
									</div>
			                    </a>
		                	...
		                	<?php while (have_rows('iwsm_tabs_items')): the_row(); ?>
			                    ...
			                    <div class="tab-pane fade <?php if (get_row_index()==1): ?>show active<?php endif ?>" id="v-pills-<?php echo get_row_index(); ?>" role="tab" aria-labelledby="v-pills-<?php echo get_row_index(); ?>-tab" role="tab">
						            ...
						            <div id="collapse-<?php echo get_row_index() ?>" class="collapse p-4 mb-3 <?php if (get_row_index()==1): ?>show<?php endif ?>" data-parent="#content" role="tabpanel" aria-labelledby="heading-<?php echo get_row_index() ?>">
				                    	...
				                    	<?php endif ?>
				                    	<?php if (get_sub_field('iwsm_title')): ?>
				                    		<h3 class="iwsm-title"><?php the_sub_field('iwsm_title') ?></h3>
				                    	<?php endif ?>

				                    	<?php if (get_sub_field('iwsm_description')): ?>
				                    		<div class="text-muted mb-2 iwsm-description"><?php the_sub_field('iwsm_description') ?></div>
				                    	<?php endif ?>
		...
		<section class="robotic-system-types-module" id="robotic-system-types-module">
			<div class="container <?php echo !empty(get_sub_field('container_padding')) ? get_sub_field('container_padding') : 'py-5' ?>">
				<?php if (get_sub_field('rstm_section_heading')): ?>
		    		<h2 class="rstm-section-heading"><?php the_sub_field('rstm_section_heading'); ?></h2>
		    	<?php endif ?>

		    	<?php if (get_sub_field('rstm_section_description')): ?>
		    		<div class="rstm-section-description"><?php the_sub_field('rstm_section_description'); ?></div>
		    	<?php endif ?>
				...
				<?php while ( have_rows('rstm_tab') ) : the_row(); ?>
					<li class="rstm-nav-item" role="presentation">
		        		<a  href="#tab<?php echo get_row_index(); ?>" data-toggle="tab" class="<?php if (get_row_index()==1): ?>active<?php endif; ?>" role="tab">
		        			...
		        			<span><?php the_sub_field('rstm_tab_title'); ?></span>
		        		</a>
					</li>
				<?php endwhile; ?>
				</ul>
					          			...
					          			<div class="rstm-tab-innercontent">
					          				<div class="rstm-content-wrap">
						          				<?php if (get_sub_field('rstm_body_heading')): ?>
										    		<h2 class="rstm-heading"><?php the_sub_field('rstm_body_heading'); ?></h2>
										    	<?php endif ?>

										    	<?php if (get_sub_field('rstm_body_description')): ?>
										    		<div class="rstm-description"><?php the_sub_field('rstm_body_description'); ?></div>
										    	<?php endif ?>
			...
			<div class="container">
				<div class="row vwdm-content-wrap">
					<div class="vwdm-media-wrap col-md-5">
						...
						<a href="https://www.youtube.com/watch?v=<?php the_sub_field('vwdm_youtube_id') ?>" class="btn btn-primary play-video-btn popup-youtube">Play Video <span class="vwdm-play-icon"><i class="fa fa-play" aria-hidden="true"></i></span></a>
					</div>

					<div class="vwdm-content col-md-7">
						<?php if (get_sub_field('vwdm_content')): ?>
				    		<div class="vwdm-content-text"><?php the_sub_field('vwdm_content'); ?></div>
				    	<?php endif ?>
					</div>
				</div>
			</div>
		...
		<section class="value-prop-module" id="value_prop_module<?php echo $i ?>">
			<div class="container">
				<?php if (get_sub_field('vpm_section_content')): ?>
		    		<div class="vpm-section-content"><?php the_sub_field('vpm_section_content'); ?></div>
		    	<?php endif ?>
		    		...
		    		<div class="col-md-6 col-lg-3 vpm-col">
		    			<div class="vpm-item">
							...
							<?php if (get_sub_field('vpm_heading')): ?>
					    		<h2 class="vpm-heading"><?php the_sub_field('vpm_heading'); ?></h2>
					    	<?php endif ?>

					    	<?php if (get_sub_field('vpm_description')): ?>
					    		<div class="vpm-description"><?php the_sub_field('vpm_description'); ?></div>
					    	<?php endif ?>
		...
		<section class="featured-listing-module" id="<?php echo $listingType .  $i; ?>">
			<div class="container <?php echo !empty(get_sub_field('container_padding')) ? get_sub_field('container_padding') : 'py-5' ?>">
				<?php if (get_sub_field('flm_section_title')): ?>
		    		<h2 class="flm-section-title"><?php the_sub_field('flm_section_title'); ?></h2>
		    	<?php endif ?>

				<?php if (get_sub_field('flm_section_content')): ?>
		    		<div class="flm-section-content mb-5"><?php the_sub_field('flm_section_content'); ?></div>
		    	<?php endif ?>
		    	...
		    	<div class="flm-featured-listing">
		    		...
		    		<?php while ( have_rows('flm_items') ) : the_row(); ?>
		    			<li class="flm-text"><?php the_sub_field('flm_text') ?></li>
		    		<?php endwhile; ?>
		    		</ul>
		    	</div>
		    	<?php endif ?>
		...
		<section class="content-on-bg-module" id="content_on_bg_module<?php echo $i ?>">
			<div class="container <?php echo !empty(get_sub_field('container_padding')) ? get_sub_field('container_padding') : 'py-5' ?>">
				<?php if (get_sub_field('cobm_section_title')): ?>
		    		<h2 class="cobm-section-title mb-5"><?php the_sub_field('cobm_section_title'); ?></h2>
		    	<?php endif ?>

				<?php if (get_sub_field('cobm_section_content')): ?>
		    		<div class="cobm-section-content"><?php the_sub_field('cobm_section_content'); ?></div>
		    	<?php endif ?>
		    </div>
	    	...
	    	<div class="row cobm-listing">
	    		...
	    		<?php if( have_rows('cobm_items') ): while ( have_rows('cobm_items') ) : the_row(); ?>	
	    			<div class="<?php echo $gridClass; ?> cobm-item" <?php if (get_sub_field('cobm_bg')): ?>style="background-image: url(<?php the_sub_field('cobm_bg') ?>)"<?php endif ?>>
	    				<?php 
						...
						<?php endif ?>
							...
							<div class="cobm-content-wrap">
			    				<?php if (get_sub_field('cobm_title')): ?>
			    					<h2 class="cobm-title"><?php the_sub_field('cobm_title') ?></h2>
			    				<?php endif ?>

			    				<?php if (get_sub_field('cobm_text')): ?>
			    					<div class="cobm-text"><?php the_sub_field('cobm_text') ?></div>
			    				<?php endif ?>
				...
				<div class="row nlm-listing">
					...
					<div class="col-md-4 nlistm-item">
						<div class="nlistm-item-wrap">
							<?php the_sub_field('nlistm_title') ?>
						</div>
					</div>
					<?php endwhile; ?>
		...
		<section class="categories-module" id="categories_module<?php echo $i ?>">
			<div class="container">
				<?php if (get_sub_field('cat_description')): ?>
					<p class="cat-description"><?php the_sub_field('cat_description') ?></p>
				<?php endif ?>
	...
	<?php elseif( get_row_layout() == 'hero_video_banner_module' ): ?>
		<section class="hero-video-banner hero-5-module" <?php if( get_sub_field('hm5_bg') ): ?>style="background-image: url(<?php the_sub_field('hm5_bg') ?>);"<?php endif; ?>>
			<?php
				...
				<div class="hm5-content <?php echo $animation; ?>">
					...
					<div class="hm5-text">
						<?php if (get_sub_field('hm5_heading')): ?>
							<h1 class="hm5-heading"><?php the_sub_field('hm5_heading'); ?></h1>
						<?php endif ?>
	
						<?php if (get_sub_field('hm5_description')): ?>
							<p class="hm5-description"><?php the_sub_field('hm5_description'); ?></p>
						<?php endif ?>
					</div>
				...
				<div class="hm7-content <?php echo $animation; ?>">
					...
					<div class="hm7-text">
						<?php if (get_sub_field('hm7_heading')): ?>
							<h1 class="hm7-heading"><?php the_sub_field('hm7_heading'); ?></h1>
						<?php endif ?>
	
						<?php if (get_sub_field('hm7_description')): ?>
							<p class="hm7-description"><?php the_sub_field('hm7_description'); ?></p>
						<?php endif ?>
					</div>
					...
					<div class="hm7-video-wrap" <?php if( get_sub_field('hm7_bg') ): ?>style="background-image: url(<?php the_sub_field('hm7_bg') ?>);"<?php endif; ?>>
						<?php
	...
	<?php elseif( get_row_layout() == 'hero6_module_module' ): ?>
		<section class="hero6-module clearfix">
			<div class="hm6-content-wrap">
				<div class="hm6-content">
					<?php if (get_sub_field('hm6_heading')): ?>
						<h1 class="hm6-heading"><?php the_sub_field('hm6_heading'); ?></h1>
					<?php endif ?>
			...
			<div class="hm6-subcategory-wrap" <?php if( get_sub_field('hm6_bg') ): ?>style="background-image: url(<?php the_sub_field('hm6_bg') ?>);"<?php endif; ?>>
				<div class="hm6-subcategory-content">
					<?php if (get_sub_field('hm6_title')): ?>
						<h2 class="hm6-title"><?php the_sub_field('hm6_title'); ?></h2>
					<?php endif ?>
	
					<?php if (get_sub_field('hm6_description')): ?>
						<p class="hm6-description"><?php the_sub_field('hm6_description'); ?></p>
					<?php endif ?>
		...
		<section class="content-associations-module">
			<div class="container <?php echo !empty(get_sub_field('container_padding')) ? get_sub_field('container_padding') : 'py-5' ?>">
				<div class="row cam-listing">
					...
					<div class="col-lg-3 col-md-12 col-12 cam-item"><h2 class="cam-title"><?php the_sub_field('cam_section_header'); ?></h2></div>
					<?php endif ?>
	...
	<?php elseif( get_row_layout() == 'content-associations_module_two' ): ?>
		<section class="content-associations-module-two">
			<div class="container <?php echo !empty(get_sub_field('container_padding')) ? get_sub_field('container_padding') : 'py-5' ?>">
				<?php if (get_sub_field('cam_section_header')): ?>
					<h2 class="cam-title"><?php the_sub_field('cam_section_header'); ?></h2>
				<?php endif ?>
				...
				<div class="row dem-listing">
					<div class="col-md-6 dem-content-wrap">
						<?php if (get_sub_field('dem_header')): ?>
							<h2 class="dem-title"><?php the_sub_field('dem_header'); ?></h2>
						<?php endif ?>

						<?php the_sub_field('dem_content'); ?>
		...
		<section class="areas-we-serve-module">
			<div class="container <?php echo !empty(get_sub_field('container_padding')) ? get_sub_field('container_padding') : 'py-5' ?>">
				<?php if (get_sub_field('aws_header')): ?>
					<h2 class="awsm-title"><?php the_sub_field('aws_header'); ?></h2>
				<?php endif ?>
				<?php if (get_sub_field('aws_sub_header')): ?>
					<p class="awsm-text"><?php the_sub_field('aws_sub_header'); ?></p>
				<?php endif ?>
				<?php if (get_sub_field('map_code')): ?>
					<div class="awsm-map"><?php the_sub_field('map_code'); ?></div>
				<?php endif ?>
			</div>
		</section>	
		...
		<section class="content-buckets-small-slider-module">
			<div class="container <?php echo !empty(get_sub_field('container_padding')) ? get_sub_field('container_padding') : 'py-5' ?>">
			  	<?php if (get_sub_field('cbss_section_header')): ?>
					<h2 class="cbssm-title"><?php the_sub_field('cbss_section_header'); ?></h2>
				<?php endif ?>
						...
						if( $link ): 
						    ...
						    <a href="<?php echo esc_url( $link_url ); ?>" target="<?php echo esc_attr( $link_target ); ?>">	<?php 
								...
								if( !empty( $image1 ) ): ?>
								   <img class="dem-img" src="<?php echo esc_url($image1['url']); ?>" alt="<?php echo esc_attr($image1['alt']); ?>" title="<?php echo esc_attr($image1['alt']); ?>" />
								<?php endif; ?>
								<?php if (get_sub_field('cbss_bucket_title')): ?><h3><?php the_sub_field('cbss_bucket_title'); ?></h3><?php endif ?>
							</a>
						<?php endif ?>							
					</div>
			      	<?php endwhile; ?>
	 			...
	 			<div class="row m-0 justify-content-center align-items-center">
	 				...
	 				<div class="col-12 col-md-6">
	 					<div class="afm-content"><?php if(get_sub_field('afm_heading')):?>
	 						<h2 class="afm-heading"><?php the_sub_field('afm_heading');?></h2><?php endif;?><?php if(get_sub_field('afm_desc')):?>
	 						<p class="afm-desc"><?php the_sub_field('afm_desc');?></p><?php endif;?>
	...
	<?php elseif( get_row_layout() == 'dest_resource_module' ): ?>
		<section class="dest-resource-module" <?php if (get_sub_field('drm_bg_color')): ?>style="background-color:<?php the_sub_field('drm_bg_color'); ?>"<?php endif ?> >
			<div class="container py-5">
				<div class="row align-items-md-center ">
					<div class="col-md-8 col-12 ">
						<div> <?php if (get_sub_field('drm_heading')): ?>
								<h2 class="cbssm-title"><?php the_sub_field('drm_heading'); ?></h2>
							<?php endif ?>
							<?php the_sub_field('drm_desc'); ?>
		...
		<section class="video-content-grid-module">
			<div class="container <?php echo !empty(get_sub_field('container_padding')) ? get_sub_field('container_padding') : 'py-5' ?>">
				<?php if (get_sub_field('vcgm_section_heading')): ?>
					<h2 class="vcgm-section-heading"><?php the_sub_field('vcgm_section_heading') ?></h2>
				<?php endif ?>
					...
					<div class="<?php echo $gridClass; ?> vcgm-item wow <?php echo $animation; ?>">
						...
						if( !empty( $cover_image ) ): ?>
							<?php if (get_sub_field('vcgm_video_link')): ?>
								<a href="<?php the_sub_field('vcgm_video_link') ?>" class="popup-youtube vcgm-link">
							<?php endif ?>
						...
						<?php if (get_sub_field('vcgm_heading')): ?>
							<h3 class="vcgm-heading"><?php the_sub_field('vcgm_heading') ?></h3>
						<?php endif ?>

						<?php if (get_sub_field('vcgm_description')): ?>
							<p class="vcgm-description"><?php the_sub_field('vcgm_description') ?></p>
						<?php endif ?>
					</div>
					<?php endwhile ?>
		...
		<section class="image-content-grid-module">
			<div class="container <?php echo !empty(get_sub_field('container_padding')) ? get_sub_field('container_padding') : 'py-5' ?>">
				<?php if (get_sub_field('icgm_section_heading')): ?>
					<h2 class="icgm-section-heading"><?php the_sub_field('icgm_section_heading') ?></h2>
				<?php endif ?>
				<?php if (get_sub_field('number_of_columns') == '2') {
					$gridClass = 'col-md-6';
				} else if (get_sub_field('number_of_columns') == '3') {
				...
				<div class="row icgm-wrap">
					...
					<div class="<?php echo $gridClass; ?> icgm-item wow <?php echo $animation; ?>">
						...
						<?php if (get_sub_field('icgm_heading')): ?>
							<h3 class="icgm-heading">
								<?php if ($link): ?>
									<a class="icgm-link" href="<?php echo esc_url( $link_url ); ?>" target="<?php echo esc_attr( $link_target ); ?>">
								<?php endif ?>
									<?php the_sub_field('icgm_heading') ?>
								<?php if (get_sub_field('icgm_link')): ?>
								</a>
							<?php endif ?>	
							</h3>
						...
						<?php if (get_sub_field('icgm_description')): ?>
							<p class="icgm-description"><?php the_sub_field('icgm_description') ?></p>
						<?php endif ?>
					</div>
					<?php endwhile ?>
				...
				<div class="row cvpnt-wrap">
					...
					<div class="col-md-6 cvpnt-content-wrap">
						<div class="cvpnt-content-inner-wrap">
							<?php if (get_sub_field('cvpt_subheading')): ?>
					    		<h2 class="cvpt-subheading"><?php the_sub_field('cvpt_subheading'); ?></h2>
					    	<?php endif ?>

							<?php if (get_sub_field('cvpt_heading')): ?>
					    		<h3 class="cvpt-heading"><?php the_sub_field('cvpt_heading'); ?></h3>
					    	<?php endif ?>

					    	<?php if (get_sub_field('cvpt_description')): ?>
					    		<p class="cvpt-description"><?php the_sub_field('cvpt_description'); ?></p>
					    	<?php endif ?>
					...
					<div class="cvpnt-tabs">
						<?php while (have_rows('cvpnt_tab_items')): the_row(); ?>
							<div class="cvpnt-tab-item">
								<h3 class="cvpnt-tab-title"><?php the_sub_field('cvpnt_tab_title'); ?></h3>
								<p class="cvpnt-tab-subtitle"><?php the_sub_field('cvpnt_tab_subtitle') ?></p>
							</div>
						<?php endwhile; ?>
					</div>
					<?php endif; ?>
			...
			<div class="container">
				...
				<?php while ( have_rows('ctl_tab') ) : the_row(); ?>
					<li class="ctl-nav-item" role="presentation">
		        		<a  href="#ctl_tab<?php echo get_row_index(); ?>" data-toggle="tab" class="<?php if (get_row_index()==1): ?>active<?php endif; ?>" role="tab"><?php the_sub_field('ctl_tab_title'); ?></a>
					</li>
				<?php endwhile; ?>
				</ul>
				<?php endif; ?>
					        ...
					        <div class="panel-heading">
						        <h2 class="panel-title h4">
						            <a data-toggle="collapse" data-parent=".tab-pane" href="#ctl_collapse<?php echo get_row_index(); ?>">
						              <?php the_sub_field('ctl_tab_title'); ?>
						            </a>
						        </h2>
					        </div>
			          			...
			          			<div class="ctl-tab-body panel-body row">
				          			...
				          			<div class="col-lg-5">
				          				<?php if (get_sub_field('ctl_subheading')): ?>
								    		<h2 class="ctl-subheading h4"><?php the_sub_field('ctl_subheading'); ?></h2>
								    	<?php endif ?>
				          				<?php if (get_sub_field('ctl_heading')): ?>
								    		<h3 class="ctl-heading h2"><?php the_sub_field('ctl_heading'); ?></h3>
								    	<?php endif ?>

								    	<?php if (get_sub_field('ctl_tab_body')): ?>
								    		<p class="ctl-description"><?php the_sub_field('ctl_tab_body'); ?></p>
								    	<?php endif ?>
				          					...
				          					<div class="col-md-6 col-12">
												...
												<?php while ( have_rows('ctl_nested_tab') ) : the_row(); ?>
													<li class="ctl-nested-nav-item" role="presentation">
										        		<a  href="#tab<?php echo $i . '_' .get_row_index(); ?>" data-toggle="tab" class="<?php if (get_row_index()==1): ?>active<?php endif; ?>" role="tab"><?php the_sub_field('ctl_tab_title'); ?></a>
													</li>
												<?php endwhile; ?>
												</ul>
				          					</div>
												        ...
												        <div id="ctl_nest_collapse<?php echo get_row_index(); ?>" class="panel-collapse collapse in">
												        	<div class="ctl-tab-panel-body panel-body">
																...
																<?php if (get_sub_field('ctl_nested_tab_content')): ?>
																	<div class="ctl-nested-tab-content"><?php the_sub_field('ctl_nested_tab_content') ?></div>
																<?php endif ?>
															</div>
	...
	<?php elseif( get_row_layout() == 'content_value_prop_2_module' ): ?>
      	<section class="content-value-prop-2 <?php if (get_sub_field('cvp2_para_img')): ?> fixed-bg<?php endif ?>" <?php if (get_sub_field('cvp2_bg_image')): ?>style="background-image: url(<?php the_sub_field('cvp2_bg_image'); ?>);"<?php endif ?> >
        	<div class="container <?php echo !empty(get_sub_field('container_padding')) ? get_sub_field('container_padding') : 'py-5' ?>">
          		<div class="cvp2-wrapper">
          			<?php $animation = get_sub_field('animation_style') != 'none' ? get_sub_field('animation_style') . ' animated' : ''; ?>
            		<div class="cvp2-content wow <?php echo $animation; ?>">
              			<?php if(get_sub_field('cvp2_subtitle')): ?>
              				<p class="sm-subtitle"><?php the_sub_field('cvp2_subtitle'); ?></p>
              			<?php endif;?>

			            <?php if(get_sub_field('cvp2_title')): ?>
			            	<h2 class="smc-title"><?php the_sub_field('cvp2_title'); ?></h2>
			            <?php endif;?>

			            <?php if(get_sub_field('cvp2_text')): ?>
			            	<div class="cvp2-desc"><?php the_sub_field('cvp2_text'); ?></div>
                		<?php endif;?>
		                	...
		                	<div class="cvp2-txt">
				                ...
				                <div class="cvp2-box cvp2-link-<?php echo $i; ?>">
				                    <?php if(get_sub_field('cvp2i_title')): ?>
				                    	<span class="cvp2i-title"><?php the_sub_field('cvp2i_title'); ?></span>
				                    <?php endif; ?>
				                    ...
				                    <?php if(get_sub_field('cvp2i_text')): ?>
				                    	<p><?php the_sub_field('cvp2i_text'); ?></p>
				                    <?php endif; ?>
			                  	</div> 
			                  	<?php $i++;endwhile; endif; ?>
		                	</div>
	        ...
	        <div class="ctl2-header">
        		<div class="container">
        			<div class="ctl2-header-wrap">
		        		<h2 class="ctl2-heading"><?php the_sub_field('ctl2_heading'); ?></h2>

						<?php if( have_rows('ctl2_tabs') ): ?>
						<ul  class="nav nav-tabs" role="tablist">
						<?php while ( have_rows('ctl2_tabs') ) : the_row(); ?>
							<li class="ctl2-nav-item nav-item" role="presentation">
				        		<a  href="#ctl2_tab<?php echo get_row_index(); ?>" data-toggle="tab" class="nav-link <?php if (get_row_index()==1): ?>active<?php endif; ?>" role="tab" <?php if (get_row_index()==1): ?>aria-selected="true"<?php else: ?>aria-selected="false"<?php endif; ?>><?php the_sub_field('ctl2_tab_title'); ?></a>
							</li>
						<?php endwhile; ?>
						</ul>
						<?php endif; ?>
					        ...
					        <div class="panel-heading">
						        <h2 class="panel-title h4">
						            <a data-toggle="collapse" data-parent=".tab-pane" href="#ctl2_collapse<?php echo get_row_index(); ?>">
						              <?php the_sub_field('ctl2_tab_title'); ?>
						            </a>
						        </h2>
					        </div>
												...
												<div class="ctl2-content">
													...
													<div class="ctl2-txt-wrap">	
														<?php if( get_sub_field('ctl2_title')): ?>											
															<h4><?php the_sub_field('ctl2_title'); ?></h4>
														<?php endif; ?> 									
														
														<?php if( get_sub_field('ctl2_description')): ?>  
															<p class="ctl2-txt"><?php the_sub_field('ctl2_description'); ?></p>
														<?php endif; ?>
	...
	<div class="cm-wrap ">
		<div class="container <?php echo !empty(get_sub_field('container_padding')) ? get_sub_field('container_padding') : 'py-5' ?> clearfix">
			...
			<h2><?php the_sub_field('cm_heading');?></h2>
			<?php endif;?>
			...
			<div><?php the_sub_field('cm_desc');?></div>
			<?php endif;?>
		</div>
	</div>
	<?php endwhile;?>
 		...
 		<div class="container">
 			...
 			<div class="afm-wrapper">
 				...
 				<div class="afm-content">
					...
					<h2 class="afm-heading"><?php the_sub_field('afm_heading');?></h2>
					<?php endif;?>
					<?php if(get_sub_field('afm_desc')):?>
					<p class="afm-desc"><?php the_sub_field('afm_desc');?></p>
					<?php endif;?>
					<?php 
					$link = get_sub_field('afm_cta');
					if( $link ): 
	...
	<section class="fullwidth-cta2" <?php if (get_sub_field('fwc_bg')): ?>style="background-image: url(<?php the_sub_field('fwc_bg'); ?>);"<?php endif ?>>
		 <div class="container">
		 	<div class="fwc2-wrap">
		 		<?php if (get_sub_field('fwc_heading')): ?>
		    		<h2 class="fwc2-heading"><?php the_sub_field('fwc_heading'); ?></h2>
		 			...
		 			<div class="row m-0 text-center">
		 				...
		 				<div class="col-12 col-md-3 col-sm-6">
		 					<div class="cpm-item  p-2">
			 					...
			 					<div class="cpm-title"><strong><?php the_sub_field('avpm_title');?></strong></div><?php endif;?>
			 					<?php if(get_sub_field('avpm_content')):?>
			 					<div class="cpm-cont"><?php the_sub_field('avpm_content');?></div>
			 					<?php endif;?>
		 					</div>
		 				</div>
		 			<?php endwhile;endif;?>
	...
	<?php elseif( get_row_layout() == 'destination_bucket_page_bucket_module' ): ?>
		<?php if (get_sub_field('bm_show')): ?>
		<section class="dbm-bucket-module" >
			<div class="container pt-3 pb-5">
				<div class="bm-wrap">
					<div class="bm-title-wrap">
						<?php if (get_sub_field('bm_heading')): ?>
			    		<h2 class="bm-heading"><?php the_sub_field('bm_heading'); ?></h2>
			    	<?php endif ?>
						<?php if (get_sub_field('bm_text')): ?>
			    		<p class="bm-text"><?php the_sub_field('bm_text'); ?></p>
			    	<?php endif ?>
		    	</div>
				...
				<?php if (have_rows('bm_items')): while ( have_rows('bm_items') ) : the_row(); ?>
					...
					<div class="col-md-6 col-lg-4">
						...
						<div class="bmi-image">
							<img src="<?php echo $bmi_image['url']; ?>" alt="<?php the_sub_field('bmi_heading'); ?>" title="<?php the_sub_field('bmi_heading'); ?>">
						</div>
						<?php endif ?>

						<div class="bm-content-wrap">							
							<?php if (get_sub_field('bmi_heading')): ?>
					    		<h3 class="bmi-heading"><?php the_sub_field('bmi_heading'); ?>
					    		</h3>
					    	<?php endif ?>
							<?php if (get_sub_field('bmi_text')): ?>
					    		<div class="bmi-text"><?php the_sub_field('bmi_text'); ?></div>
					    	<?php endif ?>
				...
				<?php if (have_rows('bm_items')): while ( have_rows('bm_items') ) : the_row(); ?>
					...
					<div class="bm-items">
						...
						<div class="bm-content-wrap col-md-6 col-lg-8 col-12">							
					    	...
					    	<?php endif ?>
							<?php if (get_sub_field('bmi_text')): ?>
					    		<p class="bmi-text"><?php the_sub_field('bmi_text'); ?></p>
					    	<?php endif ?>
...
<section class="dest-resource-module" <?php if (get_sub_field('drm_bg_img')): ?>style="background-image:url('<?php the_sub_field('drm_bg_img'); ?>');"<?php endif ?> >
	<div class="container py-5">
		<div class="row align-items-md-center ">
			<div class="col-md-7 col-12 ">
				<div> 
				<?php if (get_sub_field('drm_heading')): ?>
					<h2 class="drm-title"><?php the_sub_field('drm_heading'); ?></h2>
				<?php endif ?>
                <div class="drm-desc">
				<?php the_sub_field('drm_desc'); ?>
                </div>
...
<section class="what-we-offer">
	<div class="container <?php echo !empty(get_sub_field('container_padding')) ? get_sub_field('container_padding') : 'py-5' ?>">
		...
		<h2 class="wwo-heading"><?php the_sub_field('wwo_heading');?></h2>
		<?php endif;?>
		<?php if(get_sub_field('wwo_description')):?>
		<div class="wwo-text"><?php the_sub_field('wwo_description');?></div><?php endif;?>
		<div class="wwo-buckets">
			<div class="row">
				<?php if( have_rows('wwo_buckets') ): while ( have_rows('wwo_buckets') ) : the_row(); ?>
				<div class="col-12 col-md-4">
					<div <?php if( get_sub_field('wwo_bg')): ?>style="background-color: <?php the_sub_field('wwo_bg');?>" <?php endif; ?>>
					<?php if(get_sub_field('wwo_title')):?>
					<h3 class="wwo-title"><?php the_sub_field('wwo_title');?></h3><?php endif;?>
					<?php if(get_sub_field('wwo_content')):?>
					<div class="wwo-cont"><?php the_sub_field('wwo_content');?></div><?php endif;?>
					</div>
				</div>
				<?php endwhile; ?>
				<?php endif; ?>
...
<section class="job-openings">
	<div class="container <?php echo !empty(get_sub_field('container_padding')) ? get_sub_field('container_padding') : 'py-5' ?>">
		...
		<h2 class="jo-heading"><?php the_sub_field('jo_heading');?></h2>
		<?php endif;?>
	    ...
	    <div class="jo-bottom-module">
		    <?php if(get_sub_field('jo_apply')):?>
				...
				<div class="jo-form"><?php the_sub_field('jo_form');?></div>
				<?php endif;?>
		    <?php endif;?>	

		    <div class="jo-extra-data">
		    	<?php if(get_sub_field('jo_ex_heading')):?>
				<h2 class="jo-title"><?php the_sub_field('jo_ex_heading');?></h2>
				<?php endif;?>
				<?php if(get_sub_field('jo_ex_content')):?>
				<div class="jo-cont"><?php the_sub_field('jo_ex_content');?></div>
				<?php endif;?>
...
<section class="contact-us-module">
	...
	<div class="container">
		...
		<div class="col-12 col-md-6"><?php the_sub_field('cum_form');?></div><?php endif?>
		<div class="col-12 col-md-6">
			<?php if(get_sub_field('cum_heading')):?><h2><?php the_sub_field('cum_heading');?></h2><?php endif?><?php if(get_sub_field('cum_desc')):?>
			<div class="cum-desc"><?php the_sub_field('cum_desc');?></div><?php endif?>
		</div>
		</div>
	</div>
	...
	<div class="container">
		 			<div class="row m-0 text-center">
		 				...
		 				<div class="col-12 col-md-3 ">
		 					<div class="cpm-item  p-2">
			 					...
			 					<div class="cpm-title"><strong><?php the_sub_field('cpm_title');?></strong></div><?php endif;?>
			 					<?php if(get_sub_field('cpm_content')):?>
			 					<div class="cpm-cont"><?php the_sub_field('cpm_content');?></div>
			 					<?php endif;?>
		 					</div>
		 				</div>
		 			<?php endwhile;endif;?>
		...
		<div class="col-12 col-md-6 p-3">
			<div class="col-md-10 row justify-content-center align-items-center m-auto">
				...
				<div class="col-12 col-md-8"><?php if(get_sub_field('cum_add')):?><strong><?php the_sub_field('cum_add');?></strong><?php endif;?></div>
			</div>
		</div>
		<?php endwhile;?>
	...
	<div class="container <?php echo !empty(get_sub_field('container_padding')) ? get_sub_field('container_padding') : 'py-5' ?>">
		<div class="row">
			<div class="col-12 col-md-6">
				...
				<h2 class="lcrim-title"><?php the_sub_field('lcrim_heading');?></h2>
				<?php endif;?>
				<?php if(get_sub_field('lcrim_description')):?>
				<div class="lcrim-cont"><?php the_sub_field('lcrim_description');?></div>
				<?php endif;?>
			</div>
			<div class="col-12 col-md-6">
...
<section class="more-capcbilities">
	<div class="container <?php echo !empty(get_sub_field('container_padding')) ? get_sub_field('container_padding') : 'py-5' ?>">
		<?php if (get_sub_field('mc_heading')): ?>
			<h2 class="cbssm-title"><?php the_sub_field('mc_heading'); ?></h2>
		<?php endif ?>
...
<section class="more-product-lines">
	<div class="container <?php echo !empty(get_sub_field('container_padding')) ? get_sub_field('container_padding') : 'py-5' ?>">
		<?php if (get_sub_field('mpl_heading')): ?>
			<h2 class="cbssm-title"><?php the_sub_field('mpl_heading'); ?></h2>
		<?php endif ?>
	      	...
	      	<div class="mpl-div">
				...
				if( $link ): 
				    ...
				    <a href="<?php echo esc_url( $link_url ); ?>" target="<?php echo esc_attr( $link_target ); ?>">	<?php 
						...
						<?php endif; ?>
						<?php if (get_sub_field('mpl_title')): ?><h3><?php the_sub_field('mpl_title'); ?></h3><?php endif ?>
					</a>
				<?php endif ?>							
			</div>
	      	<?php endwhile; ?>
...
<section class="our-leadership-team-module">
	<div class="bootstrap-tabs" id="olm_bootstrap_tabs<?php echo $i ?>">
			...
			<h2 class="olt-heading"><?php the_sub_field('olt_heading'); ?></h2>
					<?php endif ?>
					<?php if (get_sub_field('olt_description')): ?>
			<div class="olt-description"><?php the_sub_field('olt_description'); ?></div><?php endif ?>
			...
			<h2 class="olt-title"><?php the_sub_field('olt_name'); ?></h2>
					<?php endif ?>
					<?php if (get_sub_field('olt_short_description')): ?>
			<div class="olt-short-description"><?php the_sub_field('olt_short_description'); ?></div>
					<?php endif ?>
		        		</div>
			...
			<div class="olt-short-description"><?php the_sub_field('olt_short_description'); ?></div>
					<?php endif ?>
						...
						<?php endif; ?>
                                          ...
                                          <?php if (get_sub_field('olt_name')): ?>
			<h2 class="olt-content-title"><?php the_sub_field('olt_name'); ?></h2>
					<?php endif ?>
					...
					<div class="olt-social-wrap">
			            ...
			            if( have_rows('olt_social_links') ): ?>
			                ...
			                while ( have_rows('olt_social_links') ) : the_row(); ?>
			                    ...
			                    ?>
			                        <a class="<?php echo $socialclass; ?>" href="<?php echo esc_url(get_sub_field('olt_social_link')); ?>" target="_blank" rel="noreferrer noopener" title="<?php the_sub_field('olt_social_profile'); ?>" aria-label="<?php the_sub_field('olt_social_profile'); ?>">
			                    <?php endif ?>
                      ...
                      <?php if (get_sub_field('olt_description')): ?>
			<div class="olt-content-text"><?php the_sub_field('olt_description'); ?></div>
					<?php endif ?>
					          			</div>
				          			</div>
	...
	<section class="our-staff-module">
		<div class="container <?php echo !empty(get_sub_field('container_padding')) ? get_field('container_sub_padding') : 'py-5' ?>">
			<?php if (get_sub_field('os_heading')): ?>
				<h2 class="os-heading"><?php the_sub_field('os_heading'); ?></h2>
			<?php endif ?>
							...
							<div class="os-overlay">
								<div class="os-verlay-wrap">
									<?php if (get_sub_field('os_name')): ?>
										<h4 class="os-name"><?php the_sub_field('os_name'); ?></h4>
									<?php endif ?>

									<?php if (get_sub_field('os_role')): ?>
										<div class="os-cont"><?php the_sub_field('os_role'); ?></div>
									<?php endif ?>
			...
			<div class="row">
				<div class="col-12 col-md-4">
					<?php if (get_sub_field('apm_heading')): ?>
						<h2 class="apm-heading"><?php the_sub_field('apm_heading'); ?></h2>
					<?php endif ?>
				</div>
				<div class="col-12 col-md-8">
...
<?php elseif( get_row_layout() == 'products_module' ): ?>
	<section class="products-module text-center" id="products_module<?php echo $i ?>">
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					<?php if(get_sub_field('pm_header')): ?>
					<h2 class="pm-header"><?php the_sub_field('pm_header'); ?></h2>
					<?php endif;?>
					<?php if(get_sub_field('pgm_desc')): ?>
					<div class="pm-desc"><?php the_sub_field('pgm_desc'); ?></div>
					<?php endif;?>
				</div>
			</div>
			<?php if( have_rows('pm_items') ): ?>
			<div class="pm-listing" id="pm_items<?php echo $i ?>">
				<?php while ( have_rows('pm_items') ) : the_row(); ?>
				<div class="pm-item-wrap">
					<?php 
					$link = get_sub_field('pm_item_link');
					if( $link ): 
						$link_url = $link['url'];
						$link_title = $link['title'] ? $link['title'] : 'Subheader';
						$link_target = $link['target'] ? $link['target'] : '_self';
					...
					<a href="<?php echo esc_url( $link_url ); ?>" target="<?php echo esc_attr( $link_target ); ?>" class="pm-item">
						...
						if( !empty( $image ) ): ?>
						<img class="pm-item-img" src="<?php echo esc_url($image['sizes'][ 'large' ]); ?>"
							alt="<?php echo esc_attr($image['alt']); ?>" title="<?php echo esc_attr($image['alt']); ?>" />
						<?php endif; ?>
						<div class="pm-hover-content">
							<span class="pm-item-btn"><span class="material-icons">add_circle_outline</span></span>
						</div>
						<?php if (get_sub_field('pm_item_title')): ?>
						<h3 class="pm-item-title"><?php the_sub_field('pm_item_title') ?></h3>
						<?php endif ?>
					</a>
			...
			<?php endif; ?>
			<?php $pm_link = get_sub_field('pm_link');
			if( $pm_link ): 
				$link_url = $pm_link['url'];
				$link_title = $pm_link['title'];
				$link_target = $pm_link['target'] ? $pm_link['target'] : '_self';
				?>
			<a href="<?php echo esc_url($link_url); ?>" class="btn-primary btn-pm"><?php echo esc_html($link_title); ?></a><?php endif;?>
		</div>
	</section>

<?php elseif( get_row_layout() == 'two_col_blurb_module' ): ?>
	<section class="two-col-blurb-module" id="two_col_blurb_module<?php echo $i ?>">
		<span class="tcbm-bg" <?php if (get_sub_field('tcbm_bg')): ?>style="background-image: url(<?php the_sub_field('tcbm_bg'); ?>);"<?php endif ?>></span>
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					<?php if(get_sub_field('tcbm_header')): ?>
					<h2 class="tcbm-header"><?php the_sub_field('tcbm_header'); ?></h2>
					<?php endif;?>
				</div>
			</div>
			<div class="row">
				<div class="col-xl-10 col-12">
					<?php if( have_rows('tcbm_blocks') ): ?>
					<div class="row tcbm-listing">
						<?php while ( have_rows('tcbm_blocks') ) : the_row(); ?>
							<div class="col-lg-6">
								<div class="tcbm-item">
									<div class="tcbm-item-img">
										<?php 
										$image = get_sub_field('tcbm_image');
										if( !empty( $image ) ): ?>
											<img src="<?php echo esc_url($image['sizes'][ 'large' ]); ?>" alt="<?php echo esc_attr($image['alt']); ?>" title="<?php echo esc_attr($image['alt']); ?>" />
										<?php endif; ?>
									</div>
									<div class="tcbm-content">
										<?php if (get_sub_field('tcbm_item_description')): ?>
											<div class="tcbm-item-description"><?php the_sub_field('tcbm_item_description'); ?></div>
										<?php endif ?>
									</div>
								</div>
							</div>
				...
				<div class="col-xl-2 col-12">
					<?php 
					$image = get_sub_field('tcbm_cert_img');
					$link = get_sub_field('tcbm_cert_link');
					if( $link ): 
					$link_url = $link['url'];
					$link_title = $link['title'] ? $link['title'] : 'Subheader';
					$link_target = $link['target'] ? $link['target'] : '_self';
					?>
					<a href="<?php echo esc_url( $link_url ); ?>" target="<?php echo esc_attr( $link_target ); ?>" class="tcbm-cert" tabindex="0"><img src="<?php echo esc_url($image['sizes'][ 'large' ]); ?>" alt="<?php echo esc_attr($image['alt']); ?>" title="<?php echo esc_attr($image['alt']); ?>" /></a>
					<?php endif; ?>
				</div>
			</div>
			<div class="row">
				<div class="col-lg-12">
					<?php $tcbmcta_link = get_sub_field('tcbm_cta_link');
					if( $tcbmcta_link ): 
						$link_url = $tcbmcta_link['url'];
						$link_title = $tcbmcta_link['title'];
						$link_target = $tcbmcta_link['target'] ? $tcbmcta_link['target'] : '_self';
						?>
					<a href="<?php echo esc_url($link_url); ?>" class="btn-alt-on-color btn-tcbm"><?php echo esc_html($link_title); ?></a>
					<?php endif;?>
				</div>
			</div>
		</div>
